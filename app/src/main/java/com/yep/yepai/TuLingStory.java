...
public class TuLingStory extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tu_ling_story);
//      初始化数据
        initView();
//       加载数据
        initData();
//      设置布局管理
    ...
    private void initData() {
        Chat c1 = new Chat("这里可以为您讲一个故事", Chat.TYPE_RECEIVED);
        list.add(c1);
    }
    /**
     * 初始化控件
    ...
    private void initView() {
        ...
        mButton = findViewById(R.id.tuling_get_story);
