...
import com.yep.yepai.baiduai.FileUtil;
import com.yep.yepai.baiduai.IDCardActivity;
import com.yep.yepai.baiduai.RecognizeService;
import com.yep.yepai.database.JsonDB;
...
import net.sf.json.JSONArray;//导入可以处理json的包
...
public class ORCResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orcresult);
        ...
        findViewById(R.id.general_basic_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ORCResultActivity.this, CameraActivity.class);
        ...
        findViewById(R.id.idcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ORCResultActivity.this, IDCardActivity.class);
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(),  "4ttk35ZUNPEKC3LLOoBCOBCD", "tp1hjssPq7NSSwtZ8EKTGTnGNpt83Msr");
    }
            ...
            RecognizeService.recGeneral(this, FileUtil.getSaveFile(getApplicationContext()).getAbsolutePath(),
                    new RecognizeService.ServiceListener() {
                        ...
                        public void onResult(String result) {
                            String resultStr = proceeJSON(result);
                            //infoPopText(result);
                            tvEdit.setText(resultStr);
                        }
                    });
        }
    ...
    public String proceeJSON(String result){
        //将前面的表头去除
        String resultStr="";
        String[] temp1;
        temp1 = result.split("\\:",5);
        String temp = temp1[4];
        try
        {
            ...
            for (int i=0; i < jsonArray.length(); i++)    {
                ...
                resultStr = resultStr + jsonObject.getString("words") +"\n";
            }
        }
        catch (Exception e)
        {
