...
public class TuLingJoke extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tu_ling_joke);
//      初始化数据
        initView();
//       加载数据
        initData();
//      设置布局管理
    ...
    private void initData() {
        Chat c1 = new Chat("这里可以为您讲一个笑话", Chat.TYPE_RECEIVED);
        list.add(c1);
    }
    /**
     * 初始化控件
    ...
    private void initView() {
        recyclerView = findViewById(R.id.recycler_joke);
        //editText = findViewById(R.id.et_text);
        mButton = findViewById(R.id.tuling_get_joke);
...
//              把接受到的数据传入addData方法中，类型是TYPE_RECEIVED接受数据
                addData(mText, Chat.TYPE_RECEIVED);//显示机器人聊天记录
