...
public class TuLingChengyu extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tu_ling_chengyu);
//      初始化数据
        initView();
//       加载数据
        initData();
//      设置布局管理
    ...
    private void initView() {
        recyclerView = findViewById(R.id.recycler_chengyu);
        editText = findViewById(R.id.et_text_chengyu);
        mButton = findViewById(R.id.tuling_get_chengyu);
