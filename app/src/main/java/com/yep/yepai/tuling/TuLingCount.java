...
public class TuLingCount extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tu_ling_count);
//      初始化数据
        initView();
//       加载数据
        initData();
//      设置布局管理
    ...
    private void initView() {
        ...
        editText = findViewById(R.id.et_text_translate);
        mButton = findViewById(R.id.tuling_get_translate);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tuling_get_translate:
                /**
                 * 1，获取输入框的内容
                 * 2，判断是否为空
                 * 3，发送后清空当前的输入框
